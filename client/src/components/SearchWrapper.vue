    ...
    <HeaderField>
        <div class="flex flex-1 flex-col items-stretch">
            ...
            <div class="mt-2 max-w-xl text-sm text-gray-200">
                <p>
                    Search for any song on YouTube and add it to the ProTube
                    playlist
                </p>
            </div>
            <form
                ...
                <div class="group flex h-10 w-full md:max-w-md">
                    <input
                        ...
                        minlength="1"
                        class="outline-hidden w-full min-w-min rounded-l-md border border-gray-400 bg-white pl-2 text-gray-700 placeholder-gray-500 focus:placeholder-gray-600"
                        placeholder="Search" />
                    <button
                        ...
                        "
                        class="bg-search_button_background-light focus:border-search_button_border focus:bg-search_button_background dark:border-search_button_background-dark dark:bg-search_button_background-dark shadow-xs focus:outline-hidden mx-auto inline-flex items-center justify-center rounded-r-md border p-2 font-medium duration-200 focus:text-white dark:text-white">
                        <font-awesome-icon
        ...
        <div
            ...
            <div
                ...
                If you are experiencing any problems with ProTube or have a
                feature request please let the
                <a
