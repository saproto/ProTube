            ...
            <div class="md:flex">
                <div class="mx-auto w-full text-center lg:w-2/3">
                    ...
                    <input
                        ...
                        @change="volumeChange" />
                    <div
                        class="container mt-2 flex flex-wrap justify-between gap-2">
                        <!--     Video/Radio toggle     -->
...
async function volumeChange(event) {
    ...
    displayToast({
        ...
        message:
            data.message ?? `Successfully Updated the volume to: ${volume}`,
    });
}
