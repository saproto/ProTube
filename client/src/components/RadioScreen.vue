<template>
  <div class="z-50">
    <div
      ...
      <img
        :alt="radio.o"
        class="absolute z-10 bg-proto_blue hover:bg-proto_blue/80 overflow-hidden truncate rounded-lg"
        style="width: 150px"
        :src="`https://www.nederland.fm/i/l/${radio.z}.gif`" />
      <div
        class="from-proto_blue absolute -left-1/4 -top-1/2 h-52 w-52 animate-[spin_3s_linear_infinite] bg-gradient-to-r via-white to-white">
