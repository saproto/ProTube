<template>
  <ContentField>
    <div class="flex flex-col">
      <div class="items-top flex flex-col justify-between md:flex-row">
        ...
        <button
          ...
          class="bg-proto_blue mt-4 flex-none rounded-md py-2 px-4 text-center text-white duration-200 hover:-translate-x-1 hover:-translate-y-0.5 hover:opacity-80 hover:shadow-lg md:mt-0">
          Clear queue
        </button>
      </div>
      <div
        class="scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-900 flex overflow-x-auto md:py-5">
        <div v-if="skeletonLoading" class="h-full flex-nowrap md:flex">
          <ul
            v-for="index in 10"
            :key="index"
            class="mt-3 inline-block grid min-h-full w-96">
            <li
              class="border-proto_blue group group col-span-1 mr-0 flex cursor-pointer flex-col rounded-sm border-l-4 text-center shadow md:mr-6">
              <SkeletonResult />
            </li>
          </ul>
        </div>
        <div v-else class="h-full md:flex md:flex-nowrap">
          <ul
            ...
            <li
              ...
              class="border-proto_blue group col-span-1 mr-0 flex flex-col rounded-sm border-l-4 text-center shadow md:mr-6">
              <div
