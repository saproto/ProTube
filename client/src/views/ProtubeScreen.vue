<template>
    <div class="dark:bg-proto_background_gray-dark">
        ...
        <div v-show="isPlayingVideo">
            <div
                ...
                <div
                    ...
                    class="bg-proto_blue z-1 rounded-xs absolute bottom-0 h-2 w-0 opacity-60"></div>
                <div :id="playerID"></div>
            </div>
        </div>
        ...
        <div v-if="isPlayingVideo">
            <div class="z-2 absolute bottom-0 mb-1 w-screen rounded-lg">
                ...
                <div
                    ...
                    <VideoCard
                        ...
                        :key="video.id"
                        :class="{
                            '': screenSettings.smallPlayer && index === 0,
                        }"
                        :index="index"
                        :title="video.title"
