...
// RoomController.get('/room');
// RoomController.get('/room').prefix = '/api';
...
server.after(() => {
    ...
    routes.register(server, routes.definedRoutes, routes.definedRoutes.prefix);
